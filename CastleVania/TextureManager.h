...
enum TEXTURE_NAME
{
	TEXTURE_SIMON, TEXTURE_ZOOMBIE, TEXTURE_MIXTURE, TEXTURE_MIXTURE_BUM, TEXURE_MORNING_STAR, TEXTURE_TILESHEET,
	...
	TEXTURE_HOLYWATER, TEXTURE_RUNMAN, TEXTURE_SHOOTMAN, TEXTURE_BOSS, TEXTURE_GHOST, TEXTURE_GREENMAN
};
