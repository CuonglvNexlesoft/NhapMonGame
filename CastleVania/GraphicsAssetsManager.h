...
enum SPRITE_INFO
{
	...
	SPRITE_INFO_HOLYWATER = 31, SPRITE_INFO_ITEM_ENDGAME = 32, SPRITE_INFO_BIRD_ITEM = 33, SPRITE_INFO_RUNMAN = 34, SPRITE_INFO_SHOOTMAN = 35,
	SPRITE_INFO_BOSS = 36, SPRITE_INFO_GHOST = 37, SPRITE_INFO_GREENMAN = 38,
