...
GraphicsAssetsManager::GraphicsAssetsManager()
{
	...
	allGraphicsAssets[SPRITE_INFO_SIMON]->getGraphicsAssetsInfomation(TEXTURE_SIMON, L"Assets/GraphicsAssets1/image.png", L"Assets/GraphicsAssets1/RYU.info.dat");
	allGraphicsAssets[SPRITE_INFO_MORNING_STAR]->getGraphicsAssetsInfomation(TEXURE_MORNING_STAR, L"Assets/GraphicsAssets/MorningStar/imagea.png", L"Assets/GraphicsAssets/MorningStar/morning_star_animation.info.dat");
	allGraphicsAssets[SPRITE_INFO_ZOOMBIE]->getGraphicsAssetsInfomation(TEXTURE_ZOOMBIE, L"Assets/GraphicsAssets/Zoombie/image.png", L"Assets/GraphicsAssets/Zoombie/swordman.info.dat");
	allGraphicsAssets[SPRITE_INFO_GREENMAN]->getGraphicsAssetsInfomation(TEXTURE_GREENMAN, L"Assets/GraphicsAssets/greenman/image.png", L"Assets/GraphicsAssets/greenman/greenman.info.dat");

	allGraphicsAssets[SPRITE_INFO_GHOST]->getGraphicsAssetsInfomation(TEXTURE_GHOST, L"Assets/GraphicsAssets/ghost/image.png", L"Assets/GraphicsAssets/ghost/ghost.info.dat");
	allGraphicsAssets[SPRITE_INFO_BOSS]->getGraphicsAssetsInfomation(TEXTURE_BOSS, L"Assets/GraphicsAssets/boss/boss.png", L"Assets/GraphicsAssets/boss/boss.dat");
	allGraphicsAssets[SPRITE_INFO_SHOOTMAN]->getGraphicsAssetsInfomation(TEXTURE_SHOOTMAN, L"Assets/GraphicsAssets/shotman/image.png", L"Assets/GraphicsAssets/shotman/shotman.info.dat");
	allGraphicsAssets[SPRITE_INFO_RUNMAN]->getGraphicsAssetsInfomation(TEXTURE_RUNMAN, L"Assets/GraphicsAssets/runman/image.png", L"Assets/GraphicsAssets/runman/runman.info.dat");
	...
	allGraphicsAssets[SPRITE_INFO_EXPLOSION_EFFECT]->getGraphicsAssetsInfomation(TEXTURE_MIXTURE_BUM, L"Assets/GraphicsAssets/Mixture/000.png", L"Assets/GraphicsAssets/Mixture/ExplosionEffect.txt");
	//allGraphicsAssets[SPRITE_INFO_EXPLOSION_EFFECT]->getGraphicsAssetsInfomation(TEXTURE_MIXTURE, L"Assets/GraphicsAssets/Mixture/image.png", L"Assets/GraphicsAssets/Mixture/butterfly.info.dat");
	...
	allGraphicsAssets[SPRITE_INFO_ITEM_SMALL_HEART]->getGraphicsAssetsInfomation(TEXTURE_MIXTURE, L"Assets/GraphicsAssets/Mixture/itemshuriken.png", L"Assets/GraphicsAssets/Mixture/itemshuriken.info.dat");
	allGraphicsAssets[SPRITE_INFO_ITEM_KNIFE]->getGraphicsAssetsInfomation(TEXTURE_MIXTURE, L"Assets/GraphicsAssets/Mixture/shuriken.png", L"Assets/GraphicsAssets/Mixture/shuriken.info.dat");
	...
	allGraphicsAssets[SPRITE_INFO_BIRD_ITEM]->getGraphicsAssetsInfomation(TEXTURE_MIXTURE, L"Assets/GraphicsAssets/Mixture/birditem.png", L"Assets/GraphicsAssets/Mixture/birditem.info.dat");
	allGraphicsAssets[SPRITE_INFO_CANDLE]->getGraphicsAssetsInfomation(TEXTURE_MIXTURE, L"Assets/GraphicsAssets/Mixture/butterfly.png", L"Assets/GraphicsAssets/Mixture/butterfly.info.dat");
	allGraphicsAssets[SPRITE_INFO_PANTHER]->getGraphicsAssetsInfomation(TEXTURE_PANTHER, L"Assets/GraphicsAssets/Panther/image.png", L"Assets/GraphicsAssets/Panther/dog.info.dat");
	...
	allGraphicsAssets[SPRITE_INFO_MERMAN_BULLET]->getGraphicsAssetsInfomation(TEXTURE_MIXTURE, L"Assets/GraphicsAssets/shotman/bullet.png", L"Assets/GraphicsAssets/shotman/bullet.info.dat");
	...
	allGraphicsAssets[SPRITE_INFO_BAT]->getGraphicsAssetsInfomation(TEXTURE_BAT, L"Assets/GraphicsAssets/bird/bird.png", L"Assets/GraphicsAssets/bird/bird.info.dat");
	allGraphicsAssets[SPRITE_INFO_KNIFE]->getGraphicsAssetsInfomation(TEXTURE_KNIFE, L"Assets/GraphicsAssets/Knife/shuriken.png", L"Assets/GraphicsAssets/Knife/shuriken.info.dat");
	...
	TEXTURE_MANAGER->Add(TEXTURE_SCOREBAR, L"Assets/GraphicsAssets/Scorebar/score_bar1.png", D3DCOLOR_XRGB(255,43,232));
}
